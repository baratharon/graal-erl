 ...
 */
@NodeInfo(shortName = "nifError")
public abstract class NifError1Builtin extends ErlBuiltinNode {

    public NifError1Builtin() {
        super(SourceSection.createUnavailable("Erlang builtin", "nif_error"));
    }

    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("erlang", "nif_error", 1)};
    }

    @Specialization
    public long nifError(Object value) {

        final ErlProcess proc = ErlProcess.getCurrentProcess();
        final ErlControlException ex = ErlControlException.createError(value);
        throw ex;
    }
}
