 ...
 * Unicode characters.
 */
@NodeInfo(shortName = "charactersToList")
public abstract class CharactersToListBuiltin extends ErlBuiltinNode {

    public CharactersToListBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "characters_to_list"));
    }

    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("unicode", "characters_to_list", 2)};
    }
    ...
    public Object charactersToList(Object data, Object inEncoding) {
        ...
        for (int i = cb.cps.size() - 1; i >= 0; --i) {
            list = new ErlList(cb.cps.get(i), list);
        }
