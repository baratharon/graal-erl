 ...
 */
@NodeInfo(shortName = "isProcessAlive")
public abstract class IsProcessAliveBuiltin extends ErlBuiltinNode {

    public IsProcessAliveBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "is_process_alive"));
    }
    ...
    @Specialization
    public boolean isProcessAlive(ErlPid pid) {
        return ErlProcess.isProcessAlive(pid);
    }

    @Specialization
    public boolean isProcessAlive(Object value) {

        if (value instanceof ErlPid) {
            return ErlProcess.isProcessAlive((ErlPid) value);
        }
