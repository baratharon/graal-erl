...
/**
 * Throws an exit. The describing term come from the child node.
 */
@NodeInfo(shortName = "exit")
public abstract class Exit1Builtin extends ErlBuiltinNode {
    ...
    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("erlang", "exit", 1)};
    }

    @Specialization
    public Object error(Object value) {

        throw ErlControlException.createExit(value);
    }
}
