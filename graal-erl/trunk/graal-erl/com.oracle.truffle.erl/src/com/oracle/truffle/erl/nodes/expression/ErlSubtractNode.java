...
/**
 * Erlang node that performs the "-" operation, which performs subtraction on arbitrary precision
 * numbers. See further information in {@link ErlAddNode}.
 */
@NodeInfo(shortName = "-")
public abstract class ErlSubtractNode extends ErlBinaryNode {

    public ErlSubtractNode(SourceSection src) {
        super(src);
    }
