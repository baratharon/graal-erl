 ...
 */
@NodeInfo(shortName = "portClose")
public abstract class PortCloseBuiltin extends ErlBuiltinNode {

    public PortCloseBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "port_close"));
    }
    ...
    @Specialization
    public boolean portClose(ErlPort port) {
        port.flush();
        port.closeSync();
        return true;
    }
    ...
    @Specialization
    public boolean portClose(Object arg1) {
        return portClose(ErlPort.fromObject(arg1));
    }
}
