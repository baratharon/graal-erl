...
/**
 * Non-recursive visitor for chardata() Erlang type concept.
 */
public abstract class CharDataVisitor {
    ...
    public CharDataVisitor() {
    }

    public CharDataVisitor accept(Object data) {
    ...
    private void process(Object data) {
        if (data instanceof ErlList) {
            ...
            try {
                visit(((BigInteger) data).longValueExact());
    ...
    protected abstract void visit(long l);
}
