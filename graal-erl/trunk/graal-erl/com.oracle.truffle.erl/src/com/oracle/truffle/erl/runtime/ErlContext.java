...
public final class ErlContext extends ExecutionContext {
    ...
    private final ErlFunctionRegistry functionRegistry;
    ...
    private ErlContext(ErlangLanguage language, BufferedReader input, PrintWriter output, boolean installBuiltins) {
        ...
        this.input = input;
        this.output = output;
        this.functionRegistry = new ErlFunctionRegistry();
     ...
     */
    public ErlFunctionRegistry getFunctionRegistry() {
    ...
    /**
     * Adds all builtin functions to the {@link ErlFunctionRegistry}. This method lists all
     * {@link ErlBuiltinNode builtin implementation classes}.
     */
    ...
    public void installBuiltin(NodeFactory<? extends ErlBuiltinNode> factory, boolean registerRootNodes) {
        installBuiltin(null, factory, registerRootNodes);
    }

    public void installBuiltin(final String optModuleName, NodeFactory<? extends ErlBuiltinNode> factory, boolean registerRootNodes) {
        /*
        ...
        ErlBuiltinNode builtinBodyNode;
        if (null == optModuleName) {
            builtinBodyNode = factory.createNode(argumentNodes, this);
        } else {
            builtinBodyNode = factory.createNode(optModuleName, argumentNodes, this);
        }
        ...
        for (MFA mfa : builtinBodyNode.getNames()) {
            ...
            ErlRootNode rootNode = new ErlRootNode(this, new FrameDescriptor(), builtinBodyNode, mfa);

            if (registerRootNodes) {
                /* Register the builtin function in our function registry. */
                getFunctionRegistry().register(moduleName, funcName, arity, ErlFunction.Origin.BUILTIN, rootNode);
            }
        }
    }
    ...
    public void evalSource(Source source) {
        ErlParser.parseErlang(this, source);
    }
