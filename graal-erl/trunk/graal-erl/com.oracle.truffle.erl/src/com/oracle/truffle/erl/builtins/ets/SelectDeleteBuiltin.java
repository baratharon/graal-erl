 ...
 */
@NodeInfo(shortName = "selectDelete")
public abstract class SelectDeleteBuiltin extends ErlBuiltinNode {

    public SelectDeleteBuiltin() {
        super(SourceSection.createUnavailable("Erlang ETS builtin", "select_delete"));
    }
    ...
    @Specialization
    public long selectDelete(Object tid, ErlList matchSpec) {
        final ErlTable tab = ErlTable.findTable(tid);
        if (null != tab) {
            return tab.selectDelete(matchSpec);
        }
    ...
    @Specialization
    public long selectDelete(Object arg1, Object arg2) {
        return selectDelete(arg1, ErlList.fromObject(arg2));
    }
}
