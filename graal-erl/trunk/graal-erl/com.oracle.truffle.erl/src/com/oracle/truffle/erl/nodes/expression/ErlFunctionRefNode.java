...
/**
 * Reference to a {@link ErlFunction function} value.
 */
@NodeInfo(shortName = "fun")
public final class ErlFunctionRefNode extends ErlExpressionNode {
    @Child private ErlExpressionNode refNode;

    public ErlFunctionRefNode(SourceSection src, ErlExpressionNode refNode) {
        super(src);
