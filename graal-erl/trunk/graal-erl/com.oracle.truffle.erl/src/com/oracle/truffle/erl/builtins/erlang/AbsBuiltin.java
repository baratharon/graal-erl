...
public abstract class AbsBuiltin extends ErlBuiltinNode {

    public AbsBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "abs"));
    }
    ...
    public long abs(long value) {
        ...
        if (value >= 0) {
            ...
            throw new ArithmeticException("abs: long overflow");
        }
    }
    ...
    @Specialization
    public Object abs(@SuppressWarnings("unused") Object value) {
