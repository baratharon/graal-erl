...
/**
 * A visitor which traverses a completely parsed Erlang AST (presumed not yet executed) and enables
 * instrumentation at a few standard kinds of nodes.
 */
public class ErlStandardASTProber implements ASTProber {
    ...
    public void probeAST(final Instrumenter instrumenter, RootNode startNode) {
        ...
        startNode.accept(new NodeVisitor() {
            ...
            public boolean visit(Node node) {
                ...
                if (!(node instanceof InstrumentationNode) && node instanceof ErlExpressionNode && node.getParent() != null && node.getSourceSection() != null) {
                    // All Erlang nodes are instrumentable, but treat expressions specially

                    if (node instanceof ErlExpressionNode) {
                        // ErlExpressionNode expressionNode = (ErlExpressionNode) node;
                        ...
                        ErlExpressionNode statementNode = (ErlExpressionNode) node;
