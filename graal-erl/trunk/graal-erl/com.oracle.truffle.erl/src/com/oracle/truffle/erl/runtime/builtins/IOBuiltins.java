...
import com.oracle.truffle.erl.builtins.io.PrintableRangeBuiltinFactory;
import com.oracle.truffle.erl.runtime.ErlContext;

public final class IOBuiltins {

    public static void install(ErlContext context, final boolean registerRootNodes) {
        context.installBuiltin(PrintableRangeBuiltinFactory.getInstance(), registerRootNodes);
    }
}
