...
/**
 * Adds a new Key to the process dictionary, associated with the value Val, and returns undefined.
 * If Key already exists, the old value is deleted and replaced by Val and the function returns the
 * old value.
 */
...
public abstract class PutBuiltin extends ErlBuiltinNode {
    ...
    public Object put(Object key, Object value) {
        Object prev = ErlProcess.dictPut(key, value);
        if (null != prev) {
            return prev;
        }
