...
public abstract class Delete1Builtin extends ErlBuiltinNode {

    public Delete1Builtin() {
    ...
    @Specialization
    public boolean lookup(Object tid) {
        final ErlTable tab = ErlTable.findTable(tid);
        if (null != tab) {

            ErlProcess.getCurrentProcess().removeTable(tab);
            tab.forget();
            return true;
        }
