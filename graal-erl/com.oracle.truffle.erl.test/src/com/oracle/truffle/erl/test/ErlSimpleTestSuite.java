...
@RunWith(ErlTestRunner.class)
@ErlTestSuite({"truffle/com.oracle.truffle.erl.test/tests", "tests"})
public class ErlSimpleTestSuite {

    public static void main(String[] args) throws Exception {
        ErlTestRunner.runInMain(ErlSimpleTestSuite.class, args);
    }
