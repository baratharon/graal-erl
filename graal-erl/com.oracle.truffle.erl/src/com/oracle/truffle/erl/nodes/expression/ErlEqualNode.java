 ...
 */
@NodeInfo(shortName = "==")
public abstract class ErlEqualNode extends ErlBinaryNode {

    public ErlEqualNode(SourceSection src) {
        super(src);
    }
    ...
    @Specialization
    protected boolean equal(BigInteger left, double right) {
        return left.doubleValue() == right;
    }

    @Specialization
    protected boolean equal(double left, BigInteger right) {
