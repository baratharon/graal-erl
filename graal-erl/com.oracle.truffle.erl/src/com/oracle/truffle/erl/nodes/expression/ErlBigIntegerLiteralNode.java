 ...
 * {@link ErlLongLiteralNode}.
 */
@NodeInfo(shortName = "const")
public final class ErlBigIntegerLiteralNode extends ErlExpressionNode {

    private final BigInteger value;

    public ErlBigIntegerLiteralNode(SourceSection src, BigInteger value) {
        super(src);
        this.value = value;
    }
