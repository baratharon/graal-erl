...
/**
 * Erlang node that performs the "rem" operation, which performs integer remainder on integers. See
 * further information in {@link ErlAddNode}.
 */
@NodeInfo(shortName = "rem")
public abstract class ErlIntegerRemainderNode extends ErlBinaryNode {

    public ErlIntegerRemainderNode(SourceSection src) {
        super(src);
    }

    @Specialization(rewriteOn = ArithmeticException.class)
    protected long remainder(long left, long right) throws ArithmeticException {
