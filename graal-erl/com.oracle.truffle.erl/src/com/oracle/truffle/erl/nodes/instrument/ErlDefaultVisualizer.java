 ...
 *
 */
public class ErlDefaultVisualizer extends DefaultVisualizer {

    private final ErlASTPrinter astPrinter;

    public ErlDefaultVisualizer() {
        this.astPrinter = new ErlASTPrinter();
    }
    ...
    public String displayMethodName(Node node) {
        ...
        if (root instanceof ErlRootNode) {
            ErlRootNode erlRootNode = (ErlRootNode) root;
            return erlRootNode.getName();
    ...
    public String displayCallTargetName(CallTarget callTarget) {
        if (callTarget instanceof RootCallTarget) {
            ...
            ErlRootNode erlRootNode = (ErlRootNode) rootCallTarget.getRootNode();
            return erlRootNode.toString();
        }
