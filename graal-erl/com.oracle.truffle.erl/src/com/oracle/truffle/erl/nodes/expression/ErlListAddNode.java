...
/**
 * Performs list concatenation operation. See further information in {@link ErlAddNode}.
 */
@NodeInfo(shortName = "++")
public class ErlListAddNode extends ErlExpressionNode {
    @Child private ErlExpressionNode lhsNode;
    @Child private ErlExpressionNode rhsNode;

    public ErlListAddNode(SourceSection src, ErlExpressionNode lhsNode, ErlExpressionNode rhsNode) {
        super(src);
    ...
    public Object executeGeneric(VirtualFrame frame) {
        return ErlList.fromObject(lhsNode.executeGeneric(frame)).append(rhsNode.executeGeneric(frame));
    }
