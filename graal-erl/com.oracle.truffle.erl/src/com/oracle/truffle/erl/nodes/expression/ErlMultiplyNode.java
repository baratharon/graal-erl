...
/**
 * Erlang node that performs the "*" operation, which performs multiplication on arbitrary precision
 * numbers. See further information in {@link ErlAddNode}.
 */
@NodeInfo(shortName = "*")
public abstract class ErlMultiplyNode extends ErlBinaryNode {

    public ErlMultiplyNode(SourceSection src) {
        super(src);
    }
    ...
    @Specialization
    @TruffleBoundary
    protected Object multiply(BigInteger left, BigInteger right) {
