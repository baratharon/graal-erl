...
/**
 * Constant literal for a {@link ErlFunction function} value, created when a function name occurs as
 * a literal in Erlang source code. Use of undefined functions are permitted, however those
 * functions will be defined later.
 */
@NodeInfo(shortName = "func")
public final class ErlFunctionLiteralNode extends ErlExpressionNode {
    private final String moduleName;
    private final String funcName;
    private final int arity;
    @CompilationFinal private ErlFunction cachedFunction;

    public ErlFunctionLiteralNode(SourceSection src, String m, String f, int a) {
        super(src);
        this.moduleName = m;
        this.funcName = f;
        this.arity = a;
