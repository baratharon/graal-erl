...
public abstract class BinaryToList1Builtin extends ErlBuiltinNode {
    ...
    @Specialization
    public ErlList binaryToList(ErlBinary bin) {
    ...
    @Specialization
    public ErlList binaryToList(ErlLazyBinary arg) {

        return binaryToList(arg.construct());
    }

    @Specialization
    public ErlList binaryToList(ErlBinaryView arg) {

        return binaryToList(arg.construct());
    }

    @Specialization
    public ErlList binaryToList(Object arg) {

        return binaryToList(ErlBinary.fromObject(arg));
    }
}
