...
public abstract class DisplayBuiltin extends ErlBuiltinNode {

    public DisplayBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "display"));
    }
    ...
    @Specialization
    public boolean display(Object arg) {
