...
public abstract class SizeBuiltin extends ErlBuiltinNode {

    public SizeBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "size"));
    }
    ...
    @Specialization
    public long size(ErlTuple value) {

        return value.getSize();
    }

    @Specialization
    public long size(ErlBinary value) {

        return value.getCompleteByteCount();
    }

    @Specialization
    public long size(ErlLazyBinary value) {

        return size(value.construct());
    }
    ...
    public long size(Object value) {
        ...
        if (value instanceof ErlTuple) {
            return size((ErlTuple) value);
        }

        if (value instanceof ErlBinary) {
            return size((ErlBinary) value);
        }

        if (value instanceof ErlLazyBinary) {
            return size(((ErlLazyBinary) value).construct());
        }
