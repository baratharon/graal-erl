...
public abstract class TruncBuiltin extends ErlBuiltinNode {

    public TruncBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "trunc"));
    }
    ...
    @Specialization
    public BigInteger trunc(BigInteger value) {

        return value;
    }

    @Specialization
    public Object trunc(Object value) {
