...
public abstract class Apply2Builtin extends ErlBuiltinNode {
    ...
    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("erlang", "apply", 2)};
    }

    @Specialization
    public Object apply(VirtualFrame frame, ErlFunction func, ErlList args) {

        return dispatchNode.executeDispatch(frame, func, args.toArray());
    }

    @Specialization
    public Object apply(VirtualFrame frame, Object arg1, Object arg2) {

        if (arg1 instanceof ErlFunction && arg2 instanceof ErlList) {
            return apply(frame, (ErlFunction) arg1, (ErlList) arg2);
        }
