 ...
 */
@NodeInfo(shortName = "erase")
public abstract class Erase1Builtin extends ErlBuiltinNode {

    public Erase1Builtin() {
        super(SourceSection.createUnavailable("Erlang builtin", "erase"));
    }

    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("erlang", "erase", 1)};
    }

    @Specialization
    public Object erase(Object key) {
        Object value = ErlProcess.dictErase(key);
        if (null != value) {
            return value;
        }
