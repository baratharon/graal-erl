...
public abstract class Atan2Builtin extends ErlBuiltinNode {

    public Atan2Builtin() {
        super(SourceSection.createUnavailable("Erlang builtin", "atan2"));
    }
    ...
    @Specialization
    public double atan2(double a, long b) {
        return Math.atan2(a, b);
    }

    @Specialization
    @TruffleBoundary
    public double atan2(long a, BigInteger b) {
        return Math.atan2(a, b.doubleValue());
    }

    @Specialization
    @TruffleBoundary
    public double atan2(BigInteger a, BigInteger b) {
    ...
    @Specialization
    public double atan2(long a, double b) {
        return Math.atan2(a, b);
    }
