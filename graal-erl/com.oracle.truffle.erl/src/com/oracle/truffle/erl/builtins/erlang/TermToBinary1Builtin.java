...
public abstract class TermToBinary1Builtin extends ErlBuiltinNode {

    public TermToBinary1Builtin() {
        super(SourceSection.createUnavailable("Erlang builtin", "term_to_binary"));
    }

    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("erlang", "term_to_binary", 1)};
    }

    @Specialization
    public ErlBinary termToBinary(Object term) {

        final byte[] bytes = ExternalTerm.toBinary(term);
