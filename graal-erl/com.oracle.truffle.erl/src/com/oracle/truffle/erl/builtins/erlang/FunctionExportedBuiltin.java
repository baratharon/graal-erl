 ...
 * false.
 */
@NodeInfo(shortName = "functionExported")
public abstract class FunctionExportedBuiltin extends ErlBuiltinNode {

    public FunctionExportedBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "function_exported"));
    }
    ...
    @Specialization
    public boolean functionExported(Object arg1, Object arg2, Object arg3) {
        return functionExported(ErlAtom.fromObject(arg1), ErlAtom.fromObject(arg2), ErlContext.decodeLong(arg3));
    }
}
