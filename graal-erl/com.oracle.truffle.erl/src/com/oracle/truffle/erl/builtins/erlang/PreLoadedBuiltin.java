 ...
 */
@NodeInfo(shortName = "preLoaded")
public abstract class PreLoadedBuiltin extends ErlBuiltinNode {

    public PreLoadedBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "pre_loaded"));
    }
