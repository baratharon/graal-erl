...
import com.oracle.truffle.erl.runtime.misc.SpawnOptions;
 ...
 */
@NodeInfo(shortName = "spawnOpt")
public abstract class SpawnOpt4Builtin extends ErlBuiltinNode {

    public SpawnOpt4Builtin() {
        super(SourceSection.createUnavailable("Erlang builtin", "spawn_opt"));
    }
    ...
    @Specialization
    public Object spawnOpt(ErlAtom module, ErlAtom func, ErlList arglist, ErlList opts) {
        ...
        ErlPid pid = ErlProcess.spawn(context, so.link(), so.monitorRef(), fun, args).getPid();
    ...
    @Specialization
    public Object spawnOpt(Object arg1, Object arg2, Object arg3, Object arg4) {
        return spawnOpt(ErlAtom.fromObject(arg1), ErlAtom.fromObject(arg2), ErlList.fromObject(arg3), ErlList.fromObject(arg4));
    }
}
