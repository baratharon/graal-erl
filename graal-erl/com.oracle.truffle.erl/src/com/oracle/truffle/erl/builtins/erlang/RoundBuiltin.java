...
public abstract class RoundBuiltin extends ErlBuiltinNode {

    public RoundBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "round"));
    }

    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("erlang", "round", 1)};
    }
    ...
    @Specialization
    public BigInteger round(BigInteger value) {
