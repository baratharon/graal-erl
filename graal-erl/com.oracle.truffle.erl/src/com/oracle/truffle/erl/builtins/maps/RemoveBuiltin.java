...
public abstract class RemoveBuiltin extends ErlBuiltinNode {

    public RemoveBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "remove"));
    }
    ...
    @Specialization
    public ErlMap remove(Object key, ErlMap map) {

        return map.makeRemoved(key);
    }
