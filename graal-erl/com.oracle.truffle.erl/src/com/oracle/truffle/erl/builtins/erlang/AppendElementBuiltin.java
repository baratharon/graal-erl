 ...
 */
@NodeInfo(shortName = "appendElement")
public abstract class AppendElementBuiltin extends ErlBuiltinNode {

    public AppendElementBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "append_element"));
    }
    ...
    @Specialization
    public ErlTuple appendElement(ErlTuple tuple, Object elem) {

        return tuple.makeAppended(elem);
    }

    @Specialization
    public ErlTuple appendElement(Object arg1, Object arg2) {

        return appendElement(ErlTuple.fromObject(arg1), arg2);
    }
}
