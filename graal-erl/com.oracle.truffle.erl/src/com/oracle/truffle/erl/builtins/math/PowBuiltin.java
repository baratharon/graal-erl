...
public abstract class PowBuiltin extends ErlBuiltinNode {

    public PowBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "pow"));
    }

    @Override
    public MFA getName() {
        return new MFA("math", "pow", 2);
    }
    ...
    @Specialization
    public double pow(long a, double b) {
        return Math.pow(a, b);
    }
    ...
    @Specialization
    public double pow(Object arg1, Object arg2) {
        return Math.pow(ErlContext.toDouble(arg1), ErlContext.toDouble(arg2));
    }
}
