 ...
 * false.
 */
@NodeInfo(shortName = "keymember")
public abstract class KeymemberBuiltin extends ErlBuiltinNode {

    public KeymemberBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "keymember"));
    }

    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("lists", "keymember", 3)};
    }

    @Specialization
    public boolean keymember(Object key, long num, ErlList tupleList) {
    ...
    @Specialization
    public boolean keymember(Object arg1, Object arg2, Object arg3) {

        return keymember(arg1, ErlContext.decodeLong(arg2), ErlList.fromObject(arg3));
    }
}
