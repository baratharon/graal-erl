 ...
 */
@NodeInfo(shortName = "halt")
public abstract class Halt1Builtin extends ErlBuiltinNode {

    public Halt1Builtin() {
        super(SourceSection.createUnavailable("Erlang builtin", "halt"));
    }

    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("erlang", "halt", 1)};
    }

    @Specialization
    public Object halt(Object arg1) {
        ErlProcess.halt();
