...
/**
 * The same as <code>run(Subject,RE,[])</code>.
 */
@NodeInfo(shortName = "run")
public abstract class Run2Builtin extends ErlBuiltinNode {
    ...
    @Override
    public MFA getName() {
        return new MFA("re", "run", 2);
    }

    @Specialization
    public Object run(Object arg1, Object arg2) {
        return CompiledRegex.run(arg1, arg2, ErlList.NIL);
    }
}
