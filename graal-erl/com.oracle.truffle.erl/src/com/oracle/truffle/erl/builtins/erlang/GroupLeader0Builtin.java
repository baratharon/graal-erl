...
public abstract class GroupLeader0Builtin extends ErlBuiltinNode {

    public GroupLeader0Builtin() {
    ...
    @Specialization
    public ErlPid groupLeader() {
        return ErlProcess.getCurrentProcess().getGroupLeader();
    }
}
