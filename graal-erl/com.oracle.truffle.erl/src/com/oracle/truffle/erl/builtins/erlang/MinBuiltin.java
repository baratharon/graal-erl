...
public abstract class MinBuiltin extends ErlBuiltinNode {

    public MinBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "min"));
    }
    ...
    public Object min(Object lhs, Object rhs) {
        ...
        if (ErlContext.compareTerms(lhs, rhs, false) <= 0) {
            return lhs;
        } else {
            return rhs;
        }
