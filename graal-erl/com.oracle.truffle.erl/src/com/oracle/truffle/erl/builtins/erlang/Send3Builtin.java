...
import com.oracle.truffle.erl.runtime.misc.SendOptions;

/**
 * Sends a message and returns ok, or does not send the message but returns something else (see
 * below). Otherwise the same as erlang:send/2. See also erlang:send_nosuspend/2,3. for more
 * detailed explanation and warnings.
 */
@NodeInfo(shortName = "send")
public abstract class Send3Builtin extends ErlBuiltinNode {
    ...
    @Specialization
    public Object send(Object arg1, Object arg2, Object arg3) {

        if (arg1 instanceof ErlPid) {
            return send((ErlPid) arg1, arg2, ErlList.fromObject(arg3));
        }

        return send(ErlAtom.fromObject(arg1), arg2, ErlList.fromObject(arg3));
    }
}
