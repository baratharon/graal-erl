 ...
 */
@NodeInfo(shortName = "garbageCollect")
public abstract class GarbageCollect0Builtin extends ErlBuiltinNode {

    public GarbageCollect0Builtin() {
        super(SourceSection.createUnavailable("Erlang builtin", "garbage_collect"));
    }
