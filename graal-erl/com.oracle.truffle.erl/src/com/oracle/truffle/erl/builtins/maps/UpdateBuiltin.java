 ...
 */
@NodeInfo(shortName = "update")
public abstract class UpdateBuiltin extends ErlBuiltinNode {

    public UpdateBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "update"));
    }
    ...
    @Specialization
    public ErlMap update(Object key, Object value, ErlMap map) {

        if (map.isKey(key)) {
            return map.makeUpdated(new ErlMap.Assoc(key, value, true));
        }

        throw ErlControlException.makeBadkey(key);
    }

    @Specialization
    public ErlMap update(Object arg1, Object arg2, Object arg3) {

        if (arg3 instanceof ErlMap) {
            return update(arg1, arg2, (ErlMap) arg3);
        }
