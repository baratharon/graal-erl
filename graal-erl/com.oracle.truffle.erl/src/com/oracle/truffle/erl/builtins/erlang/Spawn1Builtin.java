...
public abstract class Spawn1Builtin extends ErlBuiltinNode {

    private static final Object[] NO_ARGS = new Object[0];

    public Spawn1Builtin() {
    ...
    @Specialization
    public ErlPid spawn(ErlFunction func) {
        return ErlProcess.spawn(ErlProcess.getContext(), func, NO_ARGS).getPid();
    }

    @Specialization
    public ErlPid spawn(Object func) {
        return spawn(ErlFunction.fromObject(func));
    }
}
