...
public abstract class SpawnOpt2Builtin extends ErlBuiltinNode {

    private static final Object[] NO_ARGS = new Object[0];

    public SpawnOpt2Builtin() {
        super(SourceSection.createUnavailable("Erlang builtin", "spawn_opt"));
    }

    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("erlang", "spawn_opt", 2)};
    }

    @Specialization
    public Object spawnOpt(ErlFunction func, ErlList opts) {
    ...
    @Specialization
    public Object spawnOpt(Object arg1, Object arg2) {
        return spawnOpt(ErlFunction.fromObject(arg1), ErlList.fromObject(arg2));
    }
}
