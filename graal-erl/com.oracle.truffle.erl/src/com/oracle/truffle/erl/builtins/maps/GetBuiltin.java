...
public abstract class GetBuiltin extends ErlBuiltinNode {
    ...
    @Override
    public MFA[] getNames() {
        return new MFA[]{new MFA("maps", "get", 2)};
    }

    @Specialization
    public Object get(Object key, ErlMap map) {
