 ...
 * the module.
 */
@NodeInfo(shortName = "moduleLoaded")
public abstract class ModuleLoadedBuiltin extends ErlBuiltinNode {

    public ModuleLoadedBuiltin() {
        super(SourceSection.createUnavailable("Erlang builtin", "module_loaded"));
    }
    ...
    @Specialization
    public boolean moduleLoaded(Object arg1) {
        return moduleLoaded(ErlAtom.fromObject(arg1));
    }
}
