 ...
 * implementation.
 */
public class ErlException extends RuntimeException {

    private static final long serialVersionUID = 756189124416891943L;

    public ErlException(String message) {
        super(message);
    ...
    public synchronized Throwable fillInStackTrace() {
        return fillInErlStackTrace(this);
    }
     ...
     * stack.
     */
    static Throwable fillInErlStackTrace(Throwable t) {
        ...
        Truffle.getRuntime().iterateFrames(new FrameInstanceVisitor<Void>() {
            public Void visitFrame(FrameInstance frame) {
                ...
                if (root instanceof ErlRootNode) {
                    methodName = ((ErlRootNode) root).getName();
                }
                ...
                stackTrace.add(new StackTraceElement("Erlang", methodName, sourceName, lineNumber));
                return null;
            }
        });
