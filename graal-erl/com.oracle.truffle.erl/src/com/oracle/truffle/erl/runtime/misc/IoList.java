...
public final class IoList {

    private final static class ToBinaryVisitor extends IODataVisitor {
        ...
        public ErlBinary binary() {
            ...
            return ErlBinary.fromArray(data);
        }
    ...
    private final static class SizeVisitor extends IODataVisitor {
