...
public class WriteAction extends AsyncActionSingle {

    private final FDFile file;
    private final ByteBuffer bin;
    private long written = 0;

    public WriteAction(FDFile file, ByteBuffer bin) {
        super();
        this.file = file;
        this.bin = bin;
    }
    ...
    public Result async() {
        ...
        addResult(Driver.makeNumberResponse(written));
        return Result.DONE;
    }
}
