...
public class SeekAction extends AsyncActionSingle {

    private final FDFile file;
    private final long offset;
    private final int whence;

    public SeekAction(FDFile file, long offset, int whence) {
        super();
        this.file = file;
        this.offset = offset;
        this.whence = whence;
    ...
    public Result async() {
        ...
        final long curPosition = file.position();
        ...
        switch (whence) {
            case Driver.EFILE_SEEK_SET: {
                newPosition = offset;
                break;
            }

            case Driver.EFILE_SEEK_CUR: {
                newPosition = curPosition + offset;
                break;
            }

            case Driver.EFILE_SEEK_END: {
        ...
        addResult(Driver.makeNumberResponse(file.position()));
        return Result.DONE;
    }
}
