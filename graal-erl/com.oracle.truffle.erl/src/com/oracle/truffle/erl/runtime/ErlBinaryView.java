 ...
 */
public final class ErlBinaryView implements TruffleObject {

    private ErlBinary concreteBinary;
    private ErlBinary viewedBinary;
    private int bitOffset;
    private int bitSize;

    public static final ErlBinaryView EMPTY = new ErlBinaryView(ErlBinary.EMPTY, 0, 0);

    public ErlBinaryView(ErlBinary viewedBinary, int bitOffset, int bitSize) {

        this.concreteBinary = null;
        this.viewedBinary = viewedBinary;
    ...
    public ErlBinary getViewedBinary() {
        return viewedBinary;
    }
